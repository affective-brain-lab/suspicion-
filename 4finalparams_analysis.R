...
fr_human_CIs$param <- c("Signed expectation violation", "Unsigned expectation violation", "Lying oneself", "Losing")
...
rs_human_CIs$param <- c("Signed expectation violation", "Unsigned expectation violation", "Lying oneself", "Losing")
...
fr_perfect_CIs$param <- c("Signed expectation violation", "Unsigned expectation violation", "Lying oneself", "Losing")
...
rs_perfect_CIs$param <- c("Signed expectation violation", "Unsigned expectation violation", "Lying oneself", "Losing")
...
fr_lm_dprime <- summary(lm('lie_detect_dprime ~ subject_liedTRUE + subject_lostTRUE + normed_signed_e_v + normed_unsigned_e_v +
            crt + eq + aq + rgpts + 
           age + gender + ed_lev +
           lie_prop', data = master))
fr_lm_dprime_std <- lm.beta(lm('lie_detect_dprime ~ subject_liedTRUE + subject_lostTRUE + normed_signed_e_v + normed_unsigned_e_v +
            crt + eq + aq + rgpts + 
           age + gender + ed_lev +
           lie_prop', data = master))
...
fr_lm_dprime_std <- fr_lm_dprime_std[c("subject_liedTRUE", "subject_lostTRUE", "normed_signed_e_v", "normed_unsigned_e_v", "lie_prop"), ]
fr_lm_dprime_std <- data.frame(estim=fr_lm_dprime_std, params=c("subject_liedTRUE", "subject_lostTRUE", "normed_signed_e_v", "normed_unsigned_e_v", "lie_prop"))
...
fr_dprime_task_params <- ggplot(fr_lm_dprime_std, aes(x=factor(params, level=c("normed_unsigned_e_v", "normed_signed_e_v", "subject_lostTRUE", "lie_prop", "subject_lied")),
                y=estim)) +
...
lm.beta(lm('mean_suspicion_rating ~ crt + 
           age + gender + ed_lev +
           lie_prop', data = master))
rs_lm_dprime <- summary(lm('lie_detect_dprime ~ subject_liedTRUE + subject_lostTRUE + normed_signed_e_v + normed_unsigned_e_v +
            crt + 
           age + gender + ed_lev +
           lie_prop', data = master))
rs_lm_dprime_std <- lm.beta(lm('lie_detect_dprime ~ subject_liedTRUE + subject_lostTRUE + normed_signed_e_v + normed_unsigned_e_v +
            crt + 
           age + gender + ed_lev +
           lie_prop', data = master))

rs_lm_dprime_std <- data.frame(rs_lm_dprime_std$standardized.coefficients)
rs_lm_dprime_std <- rs_lm_dprime_std[c("subject_liedTRUE", "subject_lostTRUE", "normed_signed_e_v", "normed_unsigned_e_v", "lie_prop"), ]
rs_lm_dprime_std <- data.frame(estim=rs_lm_dprime_std, params=c("subject_liedTRUE", "subject_lostTRUE", "normed_signed_e_v", "normed_unsigned_e_v", "lie_prop"))
...
rs_dprime_task_params <- ggplot(rs_lm_dprime_std, aes(x=factor(params, level=c("normed_unsigned_e_v", "normed_signed_e_v", "subject_lostTRUE", "lie_prop", "subject_lied")),
                                                      y=estim)) +
  geom_bar(stat="identity") +
  theme(legend.position="none", axis.title.x=element_blank()) + 
  geom_point(data = fr_lm_dprime_std[fr_lm_dprime_std$p < .05, ], aes(x=params, y=1), shape = "*", size=10, color="black") +
